var size = 0;
var placement = 'point';
function categories_Estadisticazonal_6(feature, value, size, resolution, labelText,
...
var style_Estadisticazonal_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("group");
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("plant") !== null) {
        labelText = String(feature.get("plant"));
    }
    
    var style = categories_Estadisticazonal_6(feature, value, size, resolution, labelText,
